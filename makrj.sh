...
#
# MAKRJ.SH
#   A JSON Generator Which Makes From The "JSONPath-indexed value"
#
#   * "JSONPath-indexed value" is the following format.
...
#
# Written by 321516 (@shellshoccarjpn) / Date : Sep 14, 2016
#
